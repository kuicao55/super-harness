...
After the user provides context, invoke the `harness:harness-entry` skill with context: this is a `/super-harness:brainstorm` invocation and include the user's feature description.
